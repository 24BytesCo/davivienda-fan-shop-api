 ...
 *
 * Objetivo:
 * - Validar listados, búsquedas (UUID y slug/título), y lectura incluyendo eliminados.
 * - Validar creación con subida/eliminación de imágenes y borrado lógico.
 *
 * Notas:
...
/**
 * Tipo de repositorio simulado para facilitar mocks de TypeORM.
 */
...
describe('ProductosService', () => {
  ...
  it('findOne lanza error si término vacío', async () => {
  ...
  it('findOne por título/slug retorna producto', async () => {
    const qb = makeQueryBuilder(sampleProduct());
    (productoRepo.createQueryBuilder as jest.Mock).mockReturnValue(qb);
  ...
  it('create sube imágenes y guarda producto', async () => {
  ...
  it('remove elimina lógicamente y retorna id', async () => {
